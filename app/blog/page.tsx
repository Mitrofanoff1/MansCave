...
export const metadata: Metadata = {
  ...
  description:
    "Полезные статьи о мужских стрижках, уходе за бородой и выборе барбершопа. Гайд по барбершопам в Мурино и рядом с метро Девяткино от мастеров Men's Cave.",
  keywords:
      ...
      <div className="container mx-auto px-4 max-w-6xl py-12 md:py-20">
        ...
        <header className="mb-14 md:mb-20 max-w-3xl">
          ...
          <p className="text-white/60 text-base md:text-lg leading-relaxed">
            Гайд по мужским стрижкам, уходу за бородой и выбору барбершопа. Делимся опытом
